...
cl = LINETCR.LINE()
cl.login(token="EpLM1NcvzjKoVQq9W8o5.T7KcSucUsxqj+nFh5yBIHq.7Wtg6BllDZcu3yAhOEcBSen2Esyqpst0qw+e3CKkiEU=")
cl.loginResult()
...
targets = []
mid = cl.getProfile().mid
Bots = ["u73a9d0a0fdcc49661dc4e7dd2f463edc",mid]
self = ["u73a9d0a0fdcc49661dc4e7dd2f463edc",mid]
admin = "u73a9d0a0fdcc49661dc4e7dd2f463edc"
admsa = "u73a9d0a0fdcc49661dc4e7dd2f463edc"
owner = "u73a9d0a0fdcc49661dc4e7dd2f463edc"
adminMID = "u73a9d0a0fdcc49661dc4e7dd2f463edc"
Creator="u73a9d0a0fdcc49661dc4e7dd2f463edc"
wait = {
    "alwayRead":False,
    "detectMention":True,    
    "kickMention":False,
        ...
        if op.type == 26:
            ...
            if msg.text.lower() in ["1123"]:
                ...
                cl.sendMessage(cnt)
                        ...
                        cl.sendText(msg.to,"ครับมินคุยเมียน้อยอยู่...")
